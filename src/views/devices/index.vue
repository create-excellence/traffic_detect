<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="设备位置" prop="position" />

      <el-table-column align="center" label="预警值" prop="warning" />
    ...
    >
      ...
      >
        ...
        <el-form-item prop="position" label="预警人数">
          <el-input-number
  ...
  data() {
    return {
      ...
      rules: {
        ...
        source: [
          { required: true, message: '设备源不能为空', trigger: 'blur' },
        ],
        code: [
        ...
        warning: [
          { required: true, message: '预警人数不能为空', trigger: 'blur' },
        ],
      },
    }
  },
